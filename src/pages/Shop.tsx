  ...
  const fetchProducts = async () => {
    try {
      ...
      const sortedItems = [...activeItems].sort((a, b) => {
        const aIsNew = Array.isArray(a.categories)
          ? a.categories.some((c) => c.toLowerCase() === "new")
          : false;

        const bIsNew = Array.isArray(b.categories)
          ? b.categories.some((c) => c.toLowerCase() === "new")
          : false;
